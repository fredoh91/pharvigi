...
class CM extends CasPV
{
    ...
    #[ORM\OneToOne(inversedBy: 'cM', cascade: ['persist', 'remove'])]
    private ?DonneesComplementairesCM $DonneesComplementairesCM = null;
    ...
    public function getDonneesComplementairesCM(): ?DonneesComplementairesCM
    {
        return $this->DonneesComplementairesCM;
    }

    public function setDonneesComplementairesCM(?DonneesComplementairesCM $DonneesComplementairesCM): static
    {
        $this->DonneesComplementairesCM = $DonneesComplementairesCM;
